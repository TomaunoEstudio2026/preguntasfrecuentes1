        ...
        <header className="flex items-center justify-between px-6 py-5">
          <div className="flex items-center gap-12">
            ...
            <nav className="hidden md:flex items-center gap-10">
              <a href="https://capacitaciones-six.vercel.app/index.html" className="text-white/60 hover:text-white text-xs font-bold uppercase tracking-widest transition-colors">CursoSSSSs</a>
